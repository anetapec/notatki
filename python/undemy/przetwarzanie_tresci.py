...
class PyJazzParser:
    ...
    def search_for_next_post_preview(self):
        publish_date, publish_date_index = self.find_publish_date()
    ...
    def _find_title(self, publish_data_index):
        title_header_open = self.page_html.index('<h2 class="entry-title">', publish_data_index)
